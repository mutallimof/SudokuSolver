...
<p align="center">
  <img src="assets/sudoku_grids.png" width="500" alt="Sample handwritten Sudoku grids from the dataset"/>
...
<p align="center">
  <img src="assets/mnist_samples.png" width="600" alt="MNIST training samples used for digit recognition"/>
...
<p align="center">
  <img src="assets/loss_sudoku_rules.png" width="450" alt="Training loss curve with custom Sudoku rules loss"/>
...
<p align="center">
  <img src="assets/loss_mse.png" width="450" alt="Training loss curve with MSE"/>
...
<p align="center">
  <img src="assets/loss_crossentropy.png" width="450" alt="Training loss curve with Cross-Entropy"/>
...
That said, none of the approaches solve Sudoku reliably at scale. The CNN architecture with 10 epochs on 50K examples captures patterns but doesn't generalize to arbitrary puzzles the way a constraint solver would.
